...
const ProjectLayout = ({ id, name, description, date, demoLink, index }) => {
  ...
  return (
    <a
      ...
      className="group relative flex aspect-[3/4] sm:aspect-[4/5] w-full max-w-xs flex-col justify-between
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-2 p-4">
        <h2 className="text-lg font-black uppercase leading-tight tracking-tight text-foreground
        drop-shadow-sm break-words hyphens-auto">
          {name}
        </h2>
